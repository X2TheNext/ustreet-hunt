...
const CHECKPOINTS = [
  ...
  { id: 'service-bar',   name: 'Service Bar',                 address: '926 U St NW, Washington, DC 20001',     lat: 38.91700, lng: -77.02492, points: 10, type: 'checkpoint', perk: 'Free side with any order',                                  emoji: '🍹', word: 'POUR'      },
  { id: 'peruvian',      name: 'Peruvian Brothers',           address: '1916 14th St NW, Washington, DC 20009', lat: 38.91860, lng: -77.03200, points: 10, type: 'checkpoint', perk: 'Free sauce upgrade with any order',                         emoji: '🐔', word: 'FUEGO'     },
  ...
  { id: 'insomnia',      name: 'Insomnia Cookies',            address: '2000 14th St NW, Washington, DC 20009', lat: 38.91920, lng: -77.03215, points: 10, type: 'checkpoint', perk: 'Free cookie with any order',                                emoji: '🍪', word: 'MIDNIGHT'  },
  ...
  { id: 'pure',          name: 'Whiskey Bar',                 address: '1326 U St NW, Washington, DC 20009',    lat: 38.91732, lng: -77.03124, points: 10, type: 'checkpoint', perk: 'Free entry before 11pm with passport',                      emoji: '🥃', word: 'NEAT'      },
  ...
  { id: 'dna',           name: 'DNA Lounge',                  address: '1350 U St NW, Washington, DC 20009',    lat: 38.91737, lng: -77.03187, points: 10, type: 'checkpoint', perk: 'Buy one get one half off',                                  emoji: '🧬', word: 'STRAND'    },
  { id: 'saint-ex',      name: '&Friends Saint Ex Open Deck', address: '1337 14th St NW, Washington, DC 20005', lat: 38.90980, lng: -77.03180, points: 15, type: 'checkpoint', perk: 'Open deck access + signature cocktail discount',            emoji: '🎪', word: 'ROOFTOP'   },
  { id: 'chi-cha',       name: 'Chi-Cha Lounge',              address: '1624 U St NW, Washington, DC 20009',    lat: 38.91682, lng: -77.03752, points: 10, type: 'checkpoint', perk: '10% off hookah + Finale venue',                             emoji: '🌙', word: 'FINALE'    },
  { id: 'bens',          name: "Ben's Chili Bowl",            address: '1213 U St NW, Washington, DC 20009',    lat: 38.91713, lng: -77.02881, points: 20, type: 'bonus',      perk: "Free chili dog with any Half-Smoke purchase — BONUS stop", emoji: '🌭', word: 'HALFSMOKE' },
  { id: 'ebees',         name: "Ebees Corner Grill",          address: '1841 7th St NW, Washington, DC 20001',  lat: 38.91520, lng: -77.02150, points: 20, type: 'bonus',      perk: 'Late-night food til 2am — BONUS stop',                     emoji: '🌟', word: 'LATENIGHT' },
  { id: 'lincoln',       name: 'Lincoln Theatre',             address: '1215 U St NW, Washington, DC 20009',    lat: 38.91718, lng: -77.02891, points: 10, type: 'checkpoint', perk: 'Photo op at the marquee — post & tag to earn stamp',        emoji: '🎭', word: 'MARQUEE'   },
];
